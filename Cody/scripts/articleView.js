...
// its called in the bottom of the html. it does it so al the scripts run first.
...
// this function is called in the index html file and it does it so that all the other scripts run first.
